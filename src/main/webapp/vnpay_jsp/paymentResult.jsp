    ...
    <section style="margin-top: 50px; text-align: center;">
        ...
        <c:if test="${transResult == true}">
            <div>
                ...
                <p style="font-size: 18px; margin-top: 15px;">Số tiền: <strong>${amount} VND</strong></p>
                <p style="font-size: 18px;">Vui lòng để ý số điện thoại của nhân viên tư vấn:</p>
                <strong style="color: red; font-size: 24px;">0383459560</strong>

                <!-- Form ẩn để gửi thông tin đến DepositServlet -->
                <form id="depositForm" action="${pageContext.request.contextPath}/DepositServlet" method="post" style="display: none;">
